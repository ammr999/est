...
import 'privateacademiesdata.dart';
import '../../constants.dart';


void main() {
  runApp(MaterialApp(
    home: PrivateAcademiesPlayersList(),
  ));
}

class PrivateAcademiesPlayersList extends StatefulWidget {
  @override
  _PrivateAcademiesPlayersListState createState() =>
      _PrivateAcademiesPlayersListState();
}

class _PrivateAcademiesPlayersListState extends State<PrivateAcademiesPlayersList> {
  final List<Map<String, dynamic>> players = PrivateAcademiesData.privateAcademiesData;
  String filterText = '';
