...
import '../clubsdata/alwaslfootballplayersdata.dart';
import '../../constants.dart';
import '../clubscharts/alwaslfootballplayersdatadashboard.dart';

class AlwaslPlayersList extends StatefulWidget {
  @override
  _AlwaslPlayersListState createState() => _AlwaslPlayersListState();
}

class _AlwaslPlayersListState extends State<AlwaslPlayersList> {
  final List<Map<String, dynamic>> players = AlwaslFootballPlayersData.alwaslFootballPlayersData;
  String filterName = '';
  String filterTeam = '';
  ...
  List<String> classes = ['إماراتي', 'مقيم', 'حملة جواز', 'أبناء مواطنات',''];
                      ...
                      children: [
                        ...
                        if (selectedPlayerIndex == index)
                          for (var entry in filteredData[index].entries)
                            if (entry.key != 'Name' && entry.key != 'Team' && entry.key != 'Season' && entry.key != 'Class')
                              Padding(
              ...
              FloatingActionButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => AlwaslFootballStatistics(players: players),
                    ),
                  );
                },
                child: Text('تحليل'),
