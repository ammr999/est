...
import '../establishmentsdata/sportservicesdata.dart';
import '../../constants.dart';



class SpportServicesListMenu extends StatefulWidget {
  @override
  _SportCourtsMenuState createState() => _SportCourtsMenuState();
}

class _SportCourtsMenuState extends State<SpportServicesListMenu> {
  ...
  void _showGymDetails(BuildContext context, Map<String, dynamic> gym) {
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title: Text('بيانات شركات الخدمات الرياضية'),
          content: Column(
  ...
  Widget build(BuildContext context) {
    List<Map<String, dynamic>> filteredData = courts.where((gym) {
      return gym['ClubName'].toString().contains(filterText) ||
          gym['SportsSpecialties'].toString().contains(filterText);
    }).toList();
