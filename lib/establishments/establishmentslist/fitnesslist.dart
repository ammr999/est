...
import '../establishmentsdata/fitnessdata.dart';
import '../../constants.dart';



class FitnessListMenu extends StatefulWidget {
  @override
  _SportCourtsMenuState createState() => _SportCourtsMenuState();
}

class _SportCourtsMenuState extends State<FitnessListMenu> {
  ...
  void _showGymDetails(BuildContext context, Map<String, dynamic> gym) {
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title: Text('بيانات مراكز اللياقة البدنية'),
          content: Column(
  ...
  Widget build(BuildContext context) {
    List<Map<String, dynamic>> filteredData = courts.where((gym) {
      return gym['CenterName'].toString().contains(filterText) ||
                ...
                return GestureDetector(
                  ...
                  child: Card(
                    ...
                    child: Column(
                      ...
                      children: [
                        ListTile(
                          title: Text('CenterName: ${filteredData[index]['CenterName']}'),
                        ),
