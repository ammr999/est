...
import '../academiesdata/alwaslacademydata.dart';
import '../../../constants.dart';
import '../academiescharts/awaslacademyplayerslistchart.dart';





class AlwaslAcademyPlayersList extends StatefulWidget {
  @override
  _AlwaslAcademyPlayersListState createState() =>
      _AlwaslAcademyPlayersListState();
}

class _AlwaslAcademyPlayersListState extends State<AlwaslAcademyPlayersList> {
  final List<Map<String, dynamic>> players = AlwaslAcademyData.alwaslAcademyData;
  String filterText = '';
            ...
            children: [
              ...
              FloatingActionButton(
                onPressed: () {
                  ...
                  MaterialPageRoute(builder: (context) => AwaslAcademyStatistics(players: players)),
                  );
                },
                child: Text('تحليل'),
