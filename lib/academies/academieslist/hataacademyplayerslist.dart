...
import '../academiesdata/hattaacademydata.dart';
import '../../../constants.dart';
import '../academiescharts/hattaacademyplayerslistchart.dart';





class HattaAcademyPlayersList extends StatefulWidget {
  @override
  _HattaAcademyPlayersListState createState() =>
      _HattaAcademyPlayersListState();
}

class _HattaAcademyPlayersListState extends State<HattaAcademyPlayersList> {
  final List<Map<String, dynamic>> players = HattaAcademyData.hattaAcademyData;
  String filterText = '';
            ...
            children: [
              ...
              FloatingActionButton(
                onPressed: () {
                  ...
                  MaterialPageRoute(builder: (context) => HattaAcademyStatistics(players: players)),
                  );
                },
                child: Text('تحليل'),
