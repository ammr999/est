...
import '../academiesdata/alahliacademydata.dart';
import '../../../constants.dart';
import '../academiescharts/alahliacademyplayerslistchart.dart';



class AlahliAcademyPlayersList extends StatefulWidget {
  @override
  _AlahliAcademyPlayersListState createState() =>
      _AlahliAcademyPlayersListState();
}

class _AlahliAcademyPlayersListState extends State<AlahliAcademyPlayersList> {
  final List<Map<String, dynamic>> players = AlahliAcademyData.alahliAcademyData;
  String filterText = '';
            ...
            children: [
              ...
              FloatingActionButton(
                onPressed: () {
                  ...
                  MaterialPageRoute(builder: (context) => AlahliAcademyStatistics(players: players)),
                  );
                },
                child: Text('تحليل'),
